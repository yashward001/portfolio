      ...
      <div className="space-y-5">
        ...
        <ul className="space-y-2 font-mono text-xs">
          <li>
            ...
            <a href={`tel:${profile.phone.replace(/\s+/g, '')}`} className="text-[#00cc33] hover:text-[#00ff41]">
              {profile.phone}
            </a>
          </li>
          <li>
            <span className="text-[#004d1a]">EMAIL: </span>
            <a href={`mailto:${profile.email}`} className="text-[#00cc33] hover:text-[#00ff41]">
              {profile.email}
            </a>
          </li>
          <li>
            <span className="text-[#004d1a]">ALT:   </span>
            <a href="mailto:yashwardhansingh.tomar@outlook.com" className="text-[#00cc33] hover:text-[#00ff41]">
              yashwardhansingh.tomar@outlook.com
            </a>
          </li>
          <li>
            <span className="text-[#004d1a]">GH:    </span>
            <a href={profile.github} className="text-[#00cc33] hover:text-[#00ff41]" target="_blank" rel="noreferrer">
              {profile.github.replace('https://', '')}
            </a>
          </li>
          <li>
            <span className="text-[#004d1a]">LI:    </span>
            <a href={profile.linkedin} className="text-[#00cc33] hover:text-[#00ff41]" target="_blank" rel="noreferrer">
